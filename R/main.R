...
#' @param definition_location The location of the definition.yml file. If NULL, this function will check
#' whether a definition.yml file exists in the current directory or in `/code/`.
#'
